...
Here the app.py is modified to look for redis host by name as localhost and pushed to docker hub as pbadhe34/my-apps:app2 
...
docker ps -a
 ...
 docker run -it ubuntu bash
  ...
  docker run -p 5000:8090  -d local-app

 Start the redis 
  docker run  -d  --name redis-server --hostname redis redis

docker run  -d  --name redis-server --hostname redis-host redis
Link to redis


docker run  -p 5000:8090 -d --link redis-server:localhost --hostname myhost local-app


docker run  -p 5000:8090 -d --link redis-server:localhost --hostname myhost pbadhe34/my-apps:app2 


  Publish the image on docker hub in the format
  docker tag image username/repository:tag

 docker tag local-app pbadhe34/my-apps:app2
  ...
  docker push pbadhe34/my-apps:app2
